...
--
-- Host: localhost    Database: csdl_qlct
-- ------------------------------------------------------
...
CREATE TABLE `building` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_idx` (`host_id`),
  KEY `id_idx1` (`contractor_id`),
  CONSTRAINT `fk_building_id` FOREIGN KEY (`host_id`) REFERENCES `host` (`id`),
  CONSTRAINT `fk_contractor_id` FOREIGN KEY (`contractor_id`) REFERENCES `contractor` (`id`)
...
CREATE TABLE `design` (
  ...
  KEY `id_idx` (`architect_id`),
  CONSTRAINT `fk_architect_id` FOREIGN KEY (`architect_id`) REFERENCES `architect` (`id`),
  CONSTRAINT `fk_design_building_id` FOREIGN KEY (`building_id`) REFERENCES `building` (`id`)
...
CREATE TABLE `work` (
  ...
  CONSTRAINT `fk_work_building_id` FOREIGN KEY (`building_id`) REFERENCES `building` (`id`),
...
-- Dump completed on 2023-02-14 10:35:51
